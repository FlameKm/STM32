...
#define k_object_alloc_size(otype, size) ({ 	void * retval; 	sys_port_trace_syscall_enter(K_SYSCALL_K_OBJECT_ALLOC_SIZE, k_object_alloc_size, otype, size); 	retval = k_object_alloc_size(otype, size); 	sys_port_trace_syscall_exit(K_SYSCALL_K_OBJECT_ALLOC_SIZE, k_object_alloc_size, otype, size, retval); 	retval; })
#endif
#endif
